...
const Field& 
GameState::get_player_field() const noexcept
{ return this->_player_field; }

const Field& 
GameState::get_enemy_field() const noexcept
{ return this->_enemy_field; }

const ShipManager&
GameState::get_player_ship_manager() const noexcept
{ return this->_player_ship_manager; }

const ShipManager&
GameState::get_enemy_ship_manager() const noexcept
{ return this->_enemy_ship_manager; }

const SkillManager&
GameState::get_player_skill_manager() const noexcept
